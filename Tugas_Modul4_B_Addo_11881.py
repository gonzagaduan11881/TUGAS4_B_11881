...
def scatter(model, model_name, data, new_point, features, color_scale, title):
    ...
    fig.add_trace(
        go.Scatter3d(
            x=[new_point['Avg_Credit_Limit'].values[0]],  
            y=[new_point['Total_Credit_Cards'].values[0]],  
            z=[new_point['Total_visits_online'].values[0]],
            mode='markers',
...
st.set_page_config(
    page_title="11881 Unsupervised Learning",
    page_icon="d",
    layout="wide",
